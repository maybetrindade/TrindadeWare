package mod.trindade.dev.filepicker.files.adapters
...
import mod.trindade.dev.filepicker.files.databinding.FileItemBinding
import mod.trindade.dev.filepicker.files.extensions.getDimension
import mod.trindade.dev.filepicker.files.extensions.getDimensionPixelSize
import mod.trindade.dev.filepicker.files.extensions.layoutInflater
...
import mod.trindade.dev.filepicker.files.filelist.common.mime.MimeType
import mod.trindade.dev.filepicker.files.filelist.fileItemSetOf
import mod.trindade.dev.filepicker.files.models.FileModel
import mod.trindade.dev.filepicker.files.ui.CheckableItemBackground
import mod.trindade.dev.filepicker.files.filelist.common.mime.MimeTypeUtil
import mod.trindade.dev.filepicker.files.filepicker.style.FileItemStyle
import mod.trindade.dev.filepicker.files.models.PickOptions
import mod.trindade.dev.filepicker.files.utils.FileFormatUtils
import mod.trindade.dev.filepicker.files.utils.FileIcon

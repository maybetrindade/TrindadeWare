package mod.trindade.dev.filepicker.files.fragments
...
import mod.trindade.dev.filepicker.files.adapters.FileListAdapter
import mod.trindade.dev.filepicker.files.databinding.FragmentFileListBinding
import mod.trindade.dev.filepicker.files.extensions.getQuantityString
import mod.trindade.dev.filepicker.files.extensions.initializeTheme
import mod.trindade.dev.filepicker.files.extensions.parcelable
...
import mod.trindade.dev.filepicker.files.utils.Constants
...
import mod.trindade.dev.filepicker.files.viewmodels.FileListViewModel

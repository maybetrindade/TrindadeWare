package mod.trindade.dev.filepicker.files.filelist.common.trail
...
class TrailData private constructor(
    ...
    companion object {
        ...
        private fun Path.isArchivePath(): Boolean {
        ...
        private fun Path.archiveFile(): File? {

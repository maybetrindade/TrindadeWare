package mod.trindade.dev.preferences.inputpreference;
...
import com.trindade.ware.databinding.DialogInputPreferenceLayoutBinding;
import mod.trindade.dev.preferences.PreferencesUtil; 
...
public class InputPreference {
    ...
    public DialogInputPreferenceLayoutBinding dialogBinding;
    ...
    public void inputDialog(String title, String message, String hint, String defaultVal, View.OnClickListener listenerButtonOK, View.OnClickListener listenerButtonCancel){
        dialogBinding = DialogInputPreferenceLayoutBinding.inflate(((Activity)mContext).getLayoutInflater());

package mod.trindade.dev.gslang.methods;
...
import mod.trindade.dev.gslang.methods.Methods;
...
public class MethodCaller {
    ...
    private WeakReference<ThemedActivity> weak;
    private Methods myClassInstance;

    public MethodCaller(Context ctx, ThemedActivity main) {
